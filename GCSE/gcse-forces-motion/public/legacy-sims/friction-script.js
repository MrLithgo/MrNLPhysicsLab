...
if (!document.getElementById('initializationGuard').hasAttribute('data-initialized')) {
    document.getElementById('initializationGuard').setAttribute('data-initialized', 'true');
